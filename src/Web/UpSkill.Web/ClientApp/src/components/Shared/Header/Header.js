      ...
      <div className="header-wrapper navbar navbar-default ml-5">
        <div className="navbar header-inner navbar-light shadow bg-light fixed-top">
          <nav className="nav container navbar-center navbar-expand-lg">
              ...
              <ul className="navbar-nav ml-auto pl-lg-4 d-flex justify-content-end ms-auto w-50">
                <article className="container justify-content-around d-flex">
                  <li className="nav-item px-lg-2  text-decoration-none">
                    <NavLink
                      to="/Courses"
                      className="nav-link font-weight-bold mt-2"
                      exact={true}
                    >
                      <b>Courses</b>
                    </NavLink>
                  ...
                  <li className="nav-item px-lg-3 text-decoration-none d-flex my-auto">
                    <NavLink
                      to="/LangBg"
                      className="nav-link font-weight-bold border-right p-0 pr-2 langBg"
                      exact={true}
                    >
                      BG
                    </NavLink>
                    <NavLink
                      to="/LangEn"
                      className="nav-link font-weight-bold p-0 pl-2 me-2"
                      exact={true}
                    >
                      <b>EN</b>
                    </NavLink>
                ...
                {isLoggedIn ? (
                  <div className="navbar-nav ml-auto">
                    ...
                    >
                      <li className="nav-item px-lg-2  text-decoration-none d-flex justify-content-end">
                        <NavLink
                          to="/MyProfile"
                          className="nav-link col-xl-5 p-2"
                        >
                          <img
                            src={UserProfilePic}
                            alt="User"
                    ...
                    <li className="nav-item">
                      <NavLink
                        to="/Logout"
                        className="nav-link btn btn-light mt-2"
                      >
                        LogOut
                      </NavLink>
                    </li>
                  ...
                  <div className="navbar-nav ml-auto">
                    <li className="nav-item">
                      <NavLink
                        to="/Login"
                        className="btn btn-outline-info font-weight-bold mt-2"
                        exact={true}
                      >
                        <b>Login</b>
                      </NavLink>
              ...
              <article className="nav-item container">
                <div
                  ...
                  className={`navbar-burger burger ${
                    isActive ? "is-active" : ""
                  } navbar-toggler navbar-toggler-right border-0`}
                  aria-label="menu"
                  aria-expanded="false"
                >
            ...
            <div
              className={`collapse nav-bar navbar-burger burger ${
                isActive ? "show container" : ""
              }`}
              id="navbar4"
            >
              <ul className="navbar-nav mr-auto pl-lg-4 justify-content-center w-100">
                ...
                <li className="nav-item px-lg-2">
                  <NavLink className="nav-link text-center" to="/Courses">
                    <span className="d-inline-block d-lg-none icon-width">
                ...
                <li className="nav-item px-lg-2">
                  <NavLink className="nav-link text-center" to="/Coaches">
                    <span className="d-inline-block d-lg-none icon-width">
                ...
                <li className="nav-item px-lg-2">
                  <NavLink className="nav-link text-center" to="/MyProfile">
                    <span className="d-inline-block d-lg-none icon-width">
