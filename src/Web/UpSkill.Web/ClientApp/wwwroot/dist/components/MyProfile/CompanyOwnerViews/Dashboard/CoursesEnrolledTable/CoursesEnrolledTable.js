...
function CoursesEnrolledTable() {
    ...
    useEffect(function () {
        getCoursesForCompanyOwner('', currentPage, currentMount).then(function (mount) {
    ...
    function showMoreCourses() {
        ...
        setCurrentPage(next);
        getCoursesForCompanyOwner('', next, currentMount).then(function (mount) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'table-row header-CoursesEnrolled' },
                React.createElement(
                    'div',
                ...
                React.createElement(
                    ...
                    courses.map(function (course) {
                        return React.createElement(
                            ...
                            React.createElement(
                                'div',
                                { className: 'cell cell-data-Employees-Courses name-cell-data', 'data-title': 'Course', href: course.enrolled },
                                course.name
                            )
                        );
                    })
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'span',
                        { className: 'btn btn-link cell-data-Employees-Courses', onClick: showMoreCourses },
                        'View More'
                    )
                )
            )
