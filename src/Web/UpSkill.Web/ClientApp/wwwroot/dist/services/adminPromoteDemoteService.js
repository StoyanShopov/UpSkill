        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return axios.get("https://ourupskill.azurewebsites.net/Admin/Admin?email=" + email);
        ...
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.next = 2;
                        return axios.put("https://ourupskill.azurewebsites.net/Admin/Admin/promote?email=" + email);
        ...
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.next = 2;
                        return axios.put("https://ourupskill.azurewebsites.net/Admin/Admin/demote?email=" + email);
