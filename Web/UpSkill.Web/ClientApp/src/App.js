...
import CoursesDetailsContent from './components/Courses/CoursesDetailsContent/CoursesDetailsContent';
  ...
  return (
    <AppWrapper>
      <Route exact path='/' component={Home}/>          
          ...
          <Route exact path='/Course/:id' component={CoursesDetailsContent}/>
      </AppWrapper> 
  );
}
