        ...
        <div className="content container contentFooter">
          <div className="row">
            <div className="col-md-4">
              ...
              <p className="pr-5 pt-3 pb-3">
                Upskill gives everyone the opportunity to grow professionally
                and develop into specialist in every field.
              </p>
              <NavLink
                to=""
