                    ...
                    <div className="row">
                        ...
                        <div className="col-md-1 mt-5">
                            <ul className="nav flex-column mt-3">
                                <li className="nav-item m-1"><NavLink to="" className="nav-link text-white">F</NavLink></li>
                                <li className="nav-item m-1"><NavLink to="" className="nav-link text-white">I</NavLink></li>
                                <li className="nav-item m-1"><NavLink to="" className="nav-link text-white">In</NavLink></li>
                            </ul>
                        </div>
                    </div>                    
                </div>               
