...
export default function CoachCard(props) {
    const { displaySession, displayPrice, coachDetails: { fullName, company, coachField, imageUrl, price, session } } = props
    ...
    return (
        <div className="card">
            ...
            {
                displayPrice &&
                <span className="coachPrice">{price}€  per session</span>
            }
