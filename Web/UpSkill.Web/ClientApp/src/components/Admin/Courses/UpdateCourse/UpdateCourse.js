 ...
 let handleSubmit = (event) => {
  ...
  return (
    <div className="update-course-container">
      ...
      {isSuccess ? (
          <span style={{ color: "green", marginBottom: "1rem" }}>{success}</span>
        ) : (
        ...
        <Form onSubmit={handleSubmit}>
          <div>
            <div className="form-group">
              ...
              />
              <p style={{ color: "red", marginLeft: "15px" }}>{errors["title"]}</p>
            </div>            
            <div className="form-group">
              ...
              <span style={{ color: "red", marginLeft: "15px" }}>{errors["coachName"]}</span>
               </div>
            <div className="form-group">
              ...
              <input
                ...
                validations={[required]}
              />
              <p style={{ color: "red", marginLeft: "15px" }}>{errors["description"]}</p>
            </div>
            <div className="form-group">
              ...
              />
              <p style={{ color: "red", marginLeft: "15px" }}>{errors["price"]}</p>
            </div>
            <div className="form-group">
              ...
              <span style={{ color: "red", marginLeft: "15px" }}>{errors["category"]}</span>
            </div>
