...
export default function (props) {
  ...
  let selectedMenuStyle = {
    fontWeight: 550,
    marginTop: '20px',
    display: 'block',
    color: 'black',
  };
  let nonSelectedMenuStyle = {
    fontWeight: 350,
    marginTop: '20px',
    display: 'block',
    color: 'black',
  ...
  return (
    <div
      style={{
        ...
        backgroundColor: '#296CFB1A',
        position: 'fixed',
      }}
    >
      <div style={{ marginTop: '10%', marginBottom: '2%' }}>
        <Image
          style={{ width: 50, height: 50, display: 'inline-flex' }}
          roundedCircle={true}
        ...
        {menuItems.map((menuItem) => (
          <>
            ...
            >
              <span
                style={
                  menuItem.name === selectedMenuName
                    ? selectedMenuStyle
                    : nonSelectedMenuStyle
                }
              >
                {menuItem.name}
              </span>
