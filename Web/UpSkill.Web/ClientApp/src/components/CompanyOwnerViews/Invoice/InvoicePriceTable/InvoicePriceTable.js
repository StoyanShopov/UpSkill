        ...
        <div className="table">
            ...
            <div className="table-row px-3">
                <div className="table-totalForMonth d-flex" data-mdb-ripple-color="dark">
                    <div className="totalForMonth-heading w-50 cell"><h5 className="fw-bold">Total</h5></div>
                    <div className="totalForMonth-content w-50 text-align-end cell"><h5 className="fw-bold text-right">{totalForMonth}</h5></div> 
                </div>
            </div>
        </div>
    </div>
