            ...
            <ul>
              <li className="lecturesContentSpan">
                {lectures.map((lecture) => (
                  <li>
                    <hr />
                    <select key={lecture.id} onChange={handleResources}>
                      <option value={lecture.courseSubject}>
                        {lecture.courseSubject}
                      </option>
                      <option value={lecture.courseVideo}>Lecture Video</option>
                      <option value={lecture.resource}>Resources</option>
                    </select>
                  </li>
                ))}
              </li>
