...
export default function Home() {
  return (
    <>
      ...
      <NavLink to="/Login" className="btn btn-outline-danger m-5 font-weight-bold" exact={true}>
        <b>To Login</b>
      </NavLink>

      <NavLink to="/Register" className="btn btn-outline-primary m-5 font-weight-bold" exact={true}>
        <b>To Register</b>
      </NavLink>
